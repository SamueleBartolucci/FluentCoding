...
namespace FluentCoding.Test.FluentExtensions.Or.Generics
{
    ...
    public class Or_RightIsFuncBool_Tests
    {
        ...
        [Test]
        public void Or_String_Right1()
           => Test.LEFT.Or(() => Test.RIGHT, true)
               .Should().Be(Test.RIGHT);

        [Test]
        public void Or_String_Right2()
           => Test.LEFT.Or(() => Test.RIGHT, () => true)
               .Should().Be(Test.RIGHT);

        [Test]
        public void Or_String_Right3()
           => Test.LEFT.Or(() => Test.RIGHT, (l) => true)
               .Should().Be(Test.RIGHT);
