...
namespace FluentCoding.FluentTypes.Try._TryType
{
    /// <summary>
    ...
    public partial class TryCatch<S, R, E> : FluentContext<S>
    {
        ...
        private static B GetDefaultResult<A, B>(A subject) => default;
        private static C GetDefaultError<A, B, C>(A subject, B error) => default;
    }
}
