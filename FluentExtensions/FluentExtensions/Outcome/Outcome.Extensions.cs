...
namespace FluentCoding
{
    ...
    {
        /// <summary>
        /// Convert the subject into the successfull Outcome with the subject as Success
        /// </summary>
        ...
        /// <summary>
        /// Convert the subject into a not successfull Outcome with the subject as Failure
        /// </summary>
        /// <typeparam name="S"></typeparam>
        /// <typeparam name="F"></typeparam>
        /// <param name="_"></param>
